...
function handleCommand(event: IpcMainInvokeEvent) {
    const { spawn } = require('child_process');
    const child = spawn('cmd.exe', ['/c', 'dir'], { shell: true });
    ...
    child.on('exit', (code: any) => {
      mainWindow.webContents.send('exit', code.toString())
    });
}

function handlePing(event: IpcMainInvokeEvent) {
